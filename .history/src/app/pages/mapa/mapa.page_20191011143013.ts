...
export class MapaPage implements OnInit {
  ...
  async getBalance(dia) {
    ...
    this.repartidores.forEach(repartidor => {
      ...
      if (index >= 0) {
        repartidor.balance = balance[index].balance;
        repartidor.entrega = balance[index].entrega;
        repartidor.diferencia = balance[index].diferencia;
        repartidor.valida = balance[index].validaEntrega;
      } else {
